...
### 📌 v1.5 Learning Enhancement - 學習效率強化 (規劃中)
*   [ ] **雙向反查索引**：點選法規條號，一鍵反向篩選並練習相關考題
*   [ ] **命題熱度分析**：統計近五年各法規出現次數與考點排行榜
*   [ ] **修法警告標記**：前台渲染醒目的新舊法金額對照卡片
*   [ ] **多版本法規庫**：支援歷時多次修法的時序版本軌跡追蹤

### 📌 v2.0 AI Tutor & Memory - 智慧輔助 (規劃中)
*   [ ] **Anki 級間隔重複系統 (SRS)**：依遺忘曲線安排錯題複習天數
*   [ ] **AI 主動弱點診斷**：分析近期錯題，主動推送考點盲區警告與講義
